...
from stable_baselines3 import A2C, PPO # 离散空间 faster
...
from mlops.ml_ops.rl.finrl.envs.SB3_StockTradeEnv import StockTradeEnv
...
# model = A2C('MlpPolicy', trade_env, verbose=0)
model = PPO('MlpPolicy', trade_env, verbose=0)
